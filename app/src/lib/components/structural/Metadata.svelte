<script>
    ...
    export let image = 'favicon.ico';

    export let description = 'Some description';
    export let keywords = [];
...
<svelte:head>
    ...
    <title>O Tilt{ title != '' ? ' - ' + title : '' }</title>

    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
    <meta name="apple-mobile-web-app-title" content="O Tilt">
    <link rel="apple-touch-icon" href="{ PUBLIC_APP_URL }/{ image }">
    <meta name="apple-touch-fullscreen" content="yes">

    <meta property="og:description" content="{ description }">
    <meta property="og:image" content="{ PUBLIC_APP_URL }/{ image }">
    <meta property="og:site_name" content="O Tilt">
    <meta property="og:title" content="O Tilt{ title != '' ? ' - ' + title : '' }">
    <meta property="og:type" content="website">
    <meta property="og:url" content="{ PUBLIC_APP_URL }{ page_url }">

    <meta name="description" content="{ description }">
    <meta name="keywords" itemprop="keywords" content="{_('O Tilt')}, { keywords.toString() }">
    ...
    <meta name="twitter:site" content="@o_tilt">
    <meta name="twitter:creator" content="@o_tilt">
    <meta name="twitter:title" content="O Tilt{ title != '' ? ' - ' + title : '' }">
